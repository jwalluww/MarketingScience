...
A collection of end-to-end marketing data science projects built on realistic synthetic data. Each project solves a business problem in modern marketing analytics including measurement, attribution, personalization, pricing, and customer value, using the relevant methods in production at leading organizations.

All datasets are synthetically generated by Claude to mirror real-world complexity, like seasonality, noise, confounding, and uneven sample sizes.

---

## Why this repo exists

Marketing science represents causal inference, Bayesian modeling, and business strategy. These projects are my way of going deep on the methods that are seen in most organizations, targeting realistic problem framings with defensible modeling choices and interpretable outputs.
